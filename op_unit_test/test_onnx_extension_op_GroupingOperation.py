...
def create_onnx_model_extension():
    fps = onnx.helper.make_node(model_name, inputs=["features", "idx"], 
    ...
    input_tensors = [
        make_tensor_value_info("features", onnx.TensorProto.FLOAT, (1, 3, 20000)),
        make_tensor_value_info("idx", onnx.TensorProto.INT32, (1, 64, 8)),
    ]
    output_tensors = [make_tensor_value_info("out", onnx.TensorProto.FLOAT, (1, 3, 64, 8))]
