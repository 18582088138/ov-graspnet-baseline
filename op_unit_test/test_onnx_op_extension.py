...
def create_onnx_model_extension_with_FurthestPointSampling():
    fps = onnx.helper.make_node("FurthestPointSampling", inputs=["xyz", "npoint"], 
    ...
    input_tensors = [
        ...
        make_tensor_value_info("npoint", onnx.TensorProto.INT32, ()),
    ]
    output_tensors = [make_tensor_value_info("out", onnx.TensorProto.FLOAT, (1, 64))]
...
onnx_model_extension_with_custom_domain = "onnx_extension_FurthestPointSampling.onnx"
onnx.save_model(create_onnx_model_extension_with_FurthestPointSampling(), onnx_model_extension_with_custom_domain)
