...
def create_onnx_model_extension():
    fps = onnx.helper.make_node(model_name, inputs=['new_xyz', 'xyz', 'rot', 'radius', 'hmin', 'hmax', 'nsample'], 
    ...
    input_tensors = [
        make_tensor_value_info("new_xyz", onnx.TensorProto.FLOAT, (1, 512, 3)),
        make_tensor_value_info("xyz", onnx.TensorProto.FLOAT, (1,512,3)),
        make_tensor_value_info("rot", onnx.TensorProto.FLOAT, (1,512,9)),
        make_tensor_value_info("radius", onnx.TensorProto.FLOAT, (1,)),
        make_tensor_value_info("hmin", onnx.TensorProto.FLOAT, (1,)),
        make_tensor_value_info("hmax", onnx.TensorProto.FLOAT, (1,)),
        make_tensor_value_info("nsample", onnx.TensorProto.INT64, (1,)),
    ]
    output_tensors = [make_tensor_value_info("out", onnx.TensorProto.FLOAT, (1, 512, 64))]
